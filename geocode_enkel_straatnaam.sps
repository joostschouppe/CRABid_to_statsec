...
* bij de meeste straten liggen alle adressen van een straat in dezelfde statistische sector.
* we maken hier een lijst met de meest voorkomende statsec per straatnaam-id, en voegen een getal toe dat de kans uitdrukt dat deze juist is.
* voor statistische doeleinden kan je maar beter enkel kans=1 overhouden, aangezien je anders kleine systematische vertekeningen krijgt.
